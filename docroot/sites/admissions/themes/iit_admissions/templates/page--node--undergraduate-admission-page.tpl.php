 ...
 * This page overrides the page template for a node that is undergraduate_admission_page.
 *
 * ###  Full Width Wrappers  ###
 *
    ...
    <div id="header-wrapper">
      <div class="container clearfix">
        <header<?php print $header_attributes; ?>>
          ...
          <!-- start: IIT Section Branding -->
          <div id="iit-undergraduate-admission-branding">
            <h2>Undergraduate <span>Admission</span></h2>
          </div>
          ...
          <<?php print $tag; ?> id="main-content">
            ...
            <?php if ($title || $primary_local_tasks || $secondary_local_tasks || $action_links = render($action_links)): ?>
              <header<?php print $content_header_attributes; ?>>
                ...
                <!-- Start: Temporary IIT Page Image -->
                <img src="/<?php print drupal_get_path('theme', 'iit_admissions');?>/images/misc/iit_images18.jpg">
                <!-- End: Temporary IIT Page Image -->
