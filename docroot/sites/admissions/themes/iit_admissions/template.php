 ...
 * 1. Rename each function and instance of "iit_admissions" to match
 ...
 */
function iit_admissions_preprocess_html(&$vars) {
  global $theme_key;
  ...
  if ($_SERVER['SERVER_NAME'] == 'admission-dev.iit.edu' || $_SERVER['SERVER_NAME'] == 'admission-stg.iit.edu') {
    $metaNoIndex = array(
      '#type' => 'html_tag',
      '#tag' => 'meta',
      '#attributes' => array(
...
function iit_admissions_process_html(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function iit_admissions_preprocess_node(&$vars) {
}
function iit_admissions_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function iit_admissions_preprocess_comment(&$vars) {
}
function iit_admissions_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function iit_admissions_preprocess_block(&$vars) {
}
