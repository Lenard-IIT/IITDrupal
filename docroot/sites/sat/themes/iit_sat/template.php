 ...
 * 1. Rename each function and instance of "iit_sat" to match
 ...
 */
function iit_sat_preprocess_html(&$vars) {
  global $theme_key;
  ...
  if ($_SERVER['SERVER_NAME'] == 'sat-dev.iit.edu' || $_SERVER['SERVER_NAME'] == 'sat-stg.iit.edu') {
    $metaNoIndex = array(
      '#type' => 'html_tag',
      '#tag' => 'meta',
      '#attributes' => array(
...
function iit_sat_process_html(&$vars) {
}
// */
 ...
 */
function iit_sat_preprocess_page(&$vars) {

  $page = menu_get_item();

  if ($page['path'] == 'home') {
    //dpm($vars);
    drupal_add_js(drupal_get_path('theme', 'iit_sat') . '/scripts/home.js', array(
      'type' => 'file', 'group' => JS_THEME, 'every_page' => FALSE));
    
    drupal_add_css(drupal_get_path('theme', 'iit_sat') . '/css/home.css', array(
      'type' => 'file', 'group' => CSS_THEME, 'every_page' => FALSE));
  }

}
/* -- Delete this line if you want to use these functions
function iit_sat_process_page(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function iit_sat_preprocess_node(&$vars) {
}
function iit_sat_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function iit_sat_preprocess_comment(&$vars) {
}
function iit_sat_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function iit_sat_preprocess_block(&$vars) {
}
function iit_sat_process_block(&$vars) {
}
// */


/**
 * Override of adaptivetheme_field to iit_sat_field__field_page_section_anchor__field_page_section
 ...
 * @see field.tpl.php
 */
function iit_sat_field__field_page_section_anchor__field_page_section($vars) {
  $output = '';
...
/**
 * Override of adaptivetheme_field to iit_sat_field__field_page_section_title__field_page_section
 * Override the styling of the page section title on a page section field collection
 *
 * @param $vars
 *   An associative array containing:
 ...
 * @see field.tpl.php
 */
function iit_sat_field__field_page_section_title__field_page_section($vars) {
  $output = '';
...
/**
 * Override of adaptivetheme_field to iit_sat_field__field_page_section_content__field_page_section
 ...
 * @see field.tpl.php
 */
function iit_sat_field__field_page_section_content__field_page_section($vars) {
  $output = '';
