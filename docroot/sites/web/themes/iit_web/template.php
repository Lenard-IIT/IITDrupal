 ...
 * 1. Rename each function and instance of "iit_web" to match
 ...
 */
function iit_web_preprocess_html(&$vars) {
  global $theme_key;
...
function iit_web_process_html(&$vars) {
}
// */
...
function iit_web_preprocess_page(&$vars) {
}
function iit_web_process_page(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function iit_web_preprocess_node(&$vars) {
}
function iit_web_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function iit_web_preprocess_comment(&$vars) {
}
function iit_web_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function iit_web_preprocess_block(&$vars) {
}
function iit_web_process_block(&$vars) {
}
// */
...
/**
 * Override of adaptivetheme_field to iit_web_field__field_page_section_anchor__field_page_section
 ...
 * @see field.tpl.php
 */
function iit_web_field__field_page_section_anchor__field_page_section($vars) {
  $output = '';
...
/**
 * Override of adaptivetheme_field to iit_web_field__field_page_section_title__field_page_section
 * Override the styling of the page section title on a page section field collection
 *
 * @param $vars
 *   An associative array containing:
 ...
 * @see field.tpl.php
 */
function iit_web_field__field_page_section_title__field_page_section($vars) {
  $output = '';
...
/**
 * Override of adaptivetheme_field to iit_web_field__field_page_section_content__field_page_section
 ...
 * @see field.tpl.php
 */
function iit_web_field__field_page_section_content__field_page_section($vars) {
  $output = '';
