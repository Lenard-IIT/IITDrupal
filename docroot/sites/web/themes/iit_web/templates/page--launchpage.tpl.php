...
/**
 * @file
 * Launch Page Template - Hard coded content
 *
 * ###  Full Width Wrappers  ###
 *
 ...
 * - $page['iit_global_footer']: full width region for IIT Global Footer Block
 *
...
<div id="page-wrapper">
  <div id="page" class="<?php print $classes; ?>">
    ...
    <div id="launchpage-wrapper">
      ...
      <img id="launchpage-hero-img" src="/<?php print drupal_get_path('theme', 'iit_web');?>/images/campusphoto-launchpage.jpg">
    </div>
